...
const User = ({ params }: any) => {
  ...
  return (
    <div className="m-5">
      <Link
        className="p-3 bg-black text-white border-none rounded-lg  px-10 mx-10 mt-10"
        href="/users"
      >
        Back
      </Link>
      <div className="flex justify-center gap-6 items-center flex-col p-5 m-10 mt-2 border rounded-xl">
